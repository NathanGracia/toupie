                            ...
                            <div class="main-menu f-right d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a href="../../../Users/DeusKiwi/Documents/webhostingservice-master/about.html">About</a></li>
                                        <li><a href="../../../Users/DeusKiwi/Documents/webhostingservice-master/services.html">Services</a></li>
                                        <li><a href="../../../Users/DeusKiwi/Documents/webhostingservice-master/blog.html">Blog</a>
                                            <ul class="submenu">
                                                <li><a href="../../../Users/DeusKiwi/Documents/webhostingservice-master/blog.html">Blog</a></li>
                                                <li><a href="../../../Users/DeusKiwi/Documents/webhostingservice-master/blog_details.html">Blog Details</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="#">Pages</a>
                                            <ul class="submenu">
                                                <li><a href="../../../Users/DeusKiwi/Documents/webhostingservice-master/elements.html">Element</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="../../../Users/DeusKiwi/Documents/webhostingservice-master/contact.html">Contact</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
            ...
            <div class="single-slider d-flex align-items-center slider-height ">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-md-9 ">
                            <div class="hero__caption">
                                <h1 data-animation="fadeInLeft" data-delay=".3s">Toupie vroum vroum</h1>
                                <p data-animation="fadeInLeft" data-delay=".6s">Le meilleur site de toupies</p>
                                <!-- Slider btn -->
                                <div class="slider-btns">
                                    <!-- Hero-btn -->
                                    <a data-animation="fadeInLeft" data-delay="1s" target="_blank" href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" class="btn radius-btn">Lancer ma toupie</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <div class="row  d-flex justify-content-around">
                        <div class=""><a href="./play.php?category=attack" class="btn btn-attack" style="background: #e32121">Toupie attaque</a></div>
                        <div class=""><a href="./play.php?category=stamina" class="btn btn-stamina" style="background: #197b2a">Toupie stamina</a></div>
                        <div class=""><a href="./play.php?category=defense" class="btn btn-defense" style="background: #26266c">Toupie Defense</a></div>
